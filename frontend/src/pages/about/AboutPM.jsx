...
const AboutStats = () => {
  ...
  return (
    <section className="bg-white py-[120px] px-6 lg:px-10">
      <div className="max-w-[1269px] mx-auto flex flex-col lg:flex-row justify-between items-start gap-[80px]">
        {/* Left Content */}
        ...
        {/* Right Stats Table */}
        <div className="flex-1 w-full lg:max-w-[620px] mt-5">
          {stats.map((stat, idx) => (
            <div key={idx} className="group">
              <div className="grid grid-cols-[1fr_auto] items-center gap-8 py-[35px]">
