import Hero from "./PlumbingAndWaterSupply/Hero";
import PlumbingSpecification from "./PlumbingAndWaterSupply/PlumbingSpecification";
import PlumbingComparisonSection from "./PlumbingAndWaterSupply/PlumbingComparisonSection";
import HouseHoldApplicationsSection from "./HouseHoldAndFuelGas/HouseHoldApplicationsSection";
import HouseHoldComplianceSection from "./HouseHoldAndFuelGas/HouseHoldComplianceSection";
import PlumbingFAQ from "./PlumbingAndWaterSupply/PlumbingFAQ";
import PlumbingFooter from "./PlumbingAndWaterSupply/PlumbingFooter";
import { useNavigate } from "react-router-dom";
import WhatWeSupplySection from "../../components/WhatWeSupplySection";
const PlumbingAndWaterSupply = () => {
  ...
  return (
    <div className="w-full bg-white font-sans text-slate-800 antialiased selection:bg-cyan-600 selection:text-white overflow-x-clip">
      ...
      {/* 2 */}
      <PlumbingSpecification />

      {/* 3 */}
      <PlumbingComparisonSection />

      {/* 4 */}
      <HouseHoldApplicationsSection />

      {/* 5 */}
      <HouseHoldComplianceSection />

      {/* 6 */}
      <WhatWeSupplySection title="Tubes and fittings. One source." />

      {/* 7. CALCULATOR CALL TO ACTION */}
...
export default PlumbingAndWaterSupply;
