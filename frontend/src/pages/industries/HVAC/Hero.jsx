...
import blueprintImg from "../../../assets/industries/HVAC/hero.png"; 
import realisticImg from "../../../assets/industries/HVAC/hero2img.png"; 
      ...
      <div className="w-full max-w-[1440px] mx-auto px-8 md:px-16 lg:px-24 grid md:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div className="md:col-span-6 lg:col-span-5 space-y-5 z-10">
          <span 
            ...
            style={{ color: "#C68344" }}
          >
            Copper that performs under pressure.
          </span>
          ...
          >
            From split ACs to chiller plants — Parasmani ACR grade copper tubes, pancake coils, and wrought fittings are specified across India's most demanding HVAC&R installations.
          </motion.p>
