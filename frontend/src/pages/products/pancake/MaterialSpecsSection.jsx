  ...
  const materialSpecs = [
    {
      ...
      title: "99.90% Purity",
      description:
        "Manufactured from A-Grade copper cathodes using C12200 (DHP) phosphorus-deoxidized copper with a minimum 99.90% copper purity. Soft annealed for maximum flexibility, allowing smooth field bending without cracking or work hardening.",
    },
    {
      id: "deoxidized",
      label: "Cu ≥ 99.90%",
