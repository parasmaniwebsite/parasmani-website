...
import img5 from "../../../assets/products/sct/applicationImg5.jpg";

const industries = [
  {
    title: "HVAC & Refrigeration",
    image: img1,
    codes: ["JIS H 3300", "IS 10773"],
    path: "/hvac-refrigeration",
  },
  {
    title: "Medical Gas",
    image: img2,
    codes: ["EN 13348", "ASTM B819"],
    path: "/medical-gas",
  },
  {
    title: "Plumbing & Water Supply",
    image: img3,
    codes: ["EN 1057", "BS 2871"],
    path: "/plumbing-water-supply",
  },
  {
    title: "Household & Fuel Gas",
    image: img4,
    codes: ["EN 1057", "ASTM B837"],
    path: "/household-fuel-gas",
  },
  {
    title: "Process Piping",
    image: img5,
    codes: ["EN 12735", "ASTM B280"],
...
export default function ApplicationsSection() {
  return (
    <section className="bg-white py-10 md:py-15 font-sans selection:bg-[#C43A26]/10">
          ...
          {industries.map((item, idx) => (
            ...
            >
              ...
              <div className="absolute top-5 left-5 right-5 flex justify-between items-center text-white z-20">
                <h3 className="text-[20px] font-normal tracking-wide font-albert">
                  {item.title}
                </h3>
                <svg
